...
int main()
{
  ...
  while (j != 6)
  {
    ...
    printf("4. List the title of comic\n");
    printf("5. List the number of comic\n");
    printf("6. Exit");
    ...
    case 2:
      ...
      {
        printf("Comic name = %s", l[i].bookName);
    ...
    case 5:
      printf("\n No of comic in library : %d", keepcount);
      break;
    case 6:
      exit(0);
    }
